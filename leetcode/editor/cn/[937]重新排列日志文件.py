...
输出：["g1 act car","a8 act zoo","ab1 off key dog","a1 9 2 3 1","zo4 4 7"]
 ...
 Related Topics 数组 字符串 排序 👍 158 👎 0
    ...
    def reorderLogFiles(self, logs: List[str]) -> List[str]:
        ...
        for i in logs:
            ...
            if i[1].isdigit():
                ...
                alpha_list.append(tuple([i[0], " ".join(i[1:])]))
        alpha_list = sorted(alpha_list, key=lambda x: (x[1], x[0]))
        alpha_list = [" ".join(i) for i in alpha_list]
